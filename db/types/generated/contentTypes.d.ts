...
export interface ApiBusRouteBusRoute extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    pickup_points: Attribute.Relation<
      'api::bus-route.bus-route',
      'manyToMany',
      'api::pickup-point.pickup-point'
    >;
    publishedAt: Attribute.DateTime;
    route_status: Attribute.Enumeration<['running', 'finished  ', 'stopped']>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::bus-route.bus-route',
      'oneToOne',
...
export interface ApiNotificationNotification extends Schema.CollectionType {
  ...
  attributes: {
    ...
    notification_status: Attribute.Enumeration<['sent', 'delivered', 'read']>;
    parent: Attribute.Relation<
      'api::notification.notification',
      'manyToOne',
      'plugin::users-permissions.user'
    ...
    type: Attribute.Enumeration<['pickup', 'dropoff', 'delay', 'emergency']>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::notification.notification',
      'oneToOne',
